...
# Remove stale spatial_reasoner.egg-info directory to avoid https://github.com/pypa/pip/issues/5466
stale_egg_info = Path(__file__).parent / "spatial_reasoner.egg-info"
if stale_egg_info.exists():
    print(
        (
            "Warning: {} exists.\n\n"
            "If you recently updated spatial_reasoner, this is expected,\n"
            "but it may prevent spatial_reasoner from installing in editable mode.\n\n"
...
_deps = [
    ...
    "torch>=2.5.1",
    "transformers @ git+https://github.com/huggingface/transformers.git@d4a6b4099bc163a44335aca2dd25355fc16fa248",
